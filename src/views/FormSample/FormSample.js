            ...
            <div>
                ...
                <TcellCard  name = 'validationCard' title= 'Validation Form'  viewStore = { viewStore }>
                    <TcellForm ref={(r) => { this.validationForm = r; }} model={ValidationModel} >
                        <HorizontalForm columnCount={3}>
                            <TcellInput label="Satıcı No" name="VENDOR_ID" value={ValidationModel.$('VENDOR_ID').value} error={ValidationModel.$('VENDOR_ID').error}
                                onChange={this.handleValidationFormChange} />

                            <TcellInput label="Satıcı Adı" name="VENDOR_NAME" value={ValidationModel.$('VENDOR_NAME').value} error={ValidationModel.$('VENDOR_NAME').error}
                                onChange={this.handleValidationFormChange} />

                            <TcellInput label="E Posta" name="EMAIL" value={ValidationModel.$('EMAIL').value} error={ValidationModel.$('EMAIL').error}
                                onChange={this.handleValidationFormChange} />
